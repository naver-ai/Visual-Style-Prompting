...
import argparse
import os
from utils import parse_config, load_config, memory_efficient, get_depth_edge_array, init_latent
...
if __name__ == "__main__":
    ...
    depth_image_list = get_depth_edge_array(args.depth_img_path, feature_extractor, depth_estimator, device)
